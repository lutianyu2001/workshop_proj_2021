        ...
        <el-form class="info_form" ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row><el-col :span="22">
            <el-form-item id="selectForm" prop="event_type">
              ...
              <div class="radio_box">
                <el-radio v-model="form.event_type" label="all" style="zoom: 110%;">All</el-radio><br>
          ...
          <el-row><el-col :span="22">
            <el-form-item id="selectForm2" prop="event_type">
              ...
              <div class="radio_box">
                <el-radio v-model="format" label="YYYY" style="zoom: 110%;">YYYY (By Year)</el-radio><br>
                <el-radio v-model="format" label="YYYY-MM" style="zoom: 110%;">YYYY-MM (By Year+Month)</el-radio><br>
                <el-radio v-model="format" label="YYYY-MM-DD" style="zoom: 110%;">YYYY-MM-DD (By Specific Date)</el-radio>
              </div>
            </el-form-item>
          </el-col></el-row>
          <el-row><el-col :span="22">
            <el-form-item id="selectForm" :required=true>
